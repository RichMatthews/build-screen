...
/***/ function(module, exports, __webpack_require__) {
	...
	var Commit = function Commit(props) {
	  return _react2.default.createElement(
	    'a',
	    { className: 'commit', href: props.url, target: '_blank' },
	...
	var BuildScreen = _react2.default.createClass({
	  ...
	  getCommits: function getCommits() {
	    ...
	    var commitDate = this.getDateFromDaysAgo(14);
	    var url = 'https://api.github.com/repos/notonthehighstreet/notonthehighstreet/commits?sha=production_uk&since=' + commitDate + '&access_token=b28825b429698bc3617e5e790bb765e198415664';
	    fetch(url).then(function (response) {
	      ...
	      console.log(commits);
	      _this2.setState({ commits: commits });
	    });
	  },
	
	  getDateFromDaysAgo: function getDateFromDaysAgo(days) {
	    var dayInMillis = 8.64e7;
	    var daysAgo = dayInMillis * days;
	    var commitDate = new Date(+new Date() - daysAgo);
	
	    var year = commitDate.getFullYear();
	    var month = ('0' + (commitDate.getMonth() + 1)).slice(-2);
	    var day = ('0' + commitDate.getDate()).slice(-2);
	  ...
	  render: function render() {
	    ...
	    if (this.state.commits) {
	      commits = this.state.commits.map(function (commit, i) {
	        return _react2.default.createElement(Commit, { key: i,
	...
	_reactDom2.default.render(_react2.default.createElement(BuildScreen, { source: 'https://api.github.com/users/octocat/gists' }), document.getElementById('content'));
